        ...
        return (
            <div className={`${styles.container} glass`}>
                <div className={styles.empty}>
                    ...
                    <p>Belum ada analisis. Masukkan data transaksi terlebih dahulu.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className={styles.container}>
                    ...
                    <div key={index} className={`${styles.warningCard} glass ${getSeverityColor(warning.severity)}`}>
                        <div className={styles.warningHeader}>
                            ...
                            <span className={`${styles.badge} ${styles[warning.severity]}`}>
                                {warning.severity === 'warning' ? 'Perhatian' :
                                    warning.severity === 'caution' ? 'Hati-hati' : 'Info'}
                            </span>
                        </div>
            ...
            <div className={styles.disclaimer}>
                ...
                <p>
                    <strong>Catatan:</strong> Ini adalah penjelasan edukatif, bukan penilaian keamanan.
                    Keputusan akhir ada di tangan Anda. Kami tidak menilai apakah ini "aman" atau "scam".
                </p>
            </div>
        </div>
    );
